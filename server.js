...
ensureSchema()
const ensureTrackingSchema = require("./src/config/ensureTrackingSchema")
ensureTrackingSchema()
const ensureBatch2Schema = require("./src/config/ensureBatch2Schema")
ensureBatch2Schema()
const ensureAssistedFoodSchema = require("./src/config/ensureAssistedFoodSchema")
ensureAssistedFoodSchema()
const ensureRestaurantSchema = require("./src/config/ensureRestaurantSchema")
ensureRestaurantSchema()
const ensureProductScope = require("./src/config/ensureProductScope")
ensureProductScope()
const ensureBrandSubcategory = require("./src/config/ensureBrandSubcategory")
ensureBrandSubcategory()
const ensureMarketingSchema = require("./src/config/ensureMarketingSchema")
